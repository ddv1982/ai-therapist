...
if [ -f "$CONFIG_FILE" ]; then
  ...
  AUTONOMY=$(grep "^default_autonomy_level:" "$CONFIG_FILE" | sed 's/default_autonomy_level:[[:space:]]*//' | tr -d '"' | tr -d "'" || echo "full")
