...
if [ -z "$FACTORY_API_KEY" ]; then
  ...
  echo "   1. Config file already exists at droidz/config.yml"
  echo "   2. Get your key from: https://app.factory.ai/settings/api-keys"
  echo "   3. Update factory_api_key in droidz/config.yml"
  echo ""
