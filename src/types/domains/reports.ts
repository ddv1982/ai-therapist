 ...
 * Consolidated types for session reports, therapeutic analysis, and report generation
 */
...
// ============================================================================
// API TYPES - REPORTS (Auto-generated from OpenAPI)
// ============================================================================
...
export interface DetailedReportGenerationRequest {
  /** Format: uuid */
  sessionId: string;
  messages: {
    /** @enum {string} */
...
export interface DetailedReportGenerationResponse {
  /** @example true */
  success?: boolean;
  message?: string;
  reportContent?: string;
