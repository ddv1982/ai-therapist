import { analyzeCBTMessage, hasSchemaReflection } from '@/features/chat/lib/cbt-message-detector';
import { validateTherapeuticContext } from '@/features/therapy/lib/validators';
import * as Analysis from '@/features/therapy/lib/analysis';

// Mock dependencies
jest.mock('@/features/chat/lib/cbt-message-detector');
