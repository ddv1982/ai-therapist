  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-xl mb-2">Session Reports</h1>
        ...
        <Card className="max-w-2xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-lg">Reports Coming Soon</CardTitle>
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <h2 className="text-lg mb-6 text-center">Example Session Report</h2>
          <Card className="opacity-75">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-base">Session - March 15, 2024</CardTitle>
            ...
            <CardContent className="space-y-6">
              <div>
                <h4 className="text-base font-semibold mb-2">Key Discussion Points</h4>
              ...
              <div>
                <h4 className="text-base font-semibold mb-2">Therapeutic Insights</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <div>
                <h4 className="text-base font-semibold mb-2">Action Items</h4>
                <ul className="text-sm text-muted-foreground space-y-1">
