...
export const selectChatSettings = (
  state: RootState
): { model: string; webSearchEnabled: boolean } =>
...
export const selectIsCreatingSession = (state: RootState): boolean =>
  state.sessions?.isCreatingSession || false;
export const selectDeletingSessionId = (state: RootState): string | null =>
  state.sessions?.isDeletingSession || null;
export const selectSessionsError = (state: RootState): string | null =>
