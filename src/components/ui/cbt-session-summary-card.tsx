    ...
    <Card className={cn(
      ...
      <CardContent className="space-y-6">
        ...
        {data.initialEmotions && data.initialEmotions.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-x-4 gap-y-2 items-start">
            <div className="text-blue-900 dark:text-blue-100">
              <h4 className="font-semibold">Initial Emotions</h4>
            </div>
        ...
        {data.automaticThoughts && data.automaticThoughts.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-x-4 gap-y-2 items-start">
            <div className="text-blue-900 dark:text-blue-100">
              <h4 className="font-semibold">Automatic Thoughts</h4>
            </div>
            <div className="rounded-md border border-blue-200/60 dark:border-blue-800/40 divide-y divide-blue-200/60 dark:divide-blue-800/40 bg-blue-50/20 dark:bg-blue-950/10">
              ...
              {data.automaticThoughts.length > 3 && (
                <div className="py-2 px-3">
                  <p className="text-sm text-blue-600 dark:text-blue-400 italic">+{data.automaticThoughts.length - 3} more thoughts</p>
                </div>
              )}
            </div>
          </div>
        ...
        {data.coreBelief && (
          <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-x-4 gap-y-2 items-start">
            <div className="text-blue-900 dark:text-blue-100">
              <h4 className="font-semibold">Core Belief</h4>
            </div>
            <div>
        ...
        {data.rationalThoughts && data.rationalThoughts.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-x-4 gap-y-2 items-start">
            <div className="text-blue-900 dark:text-blue-100">
              <h4 className="font-semibold">Rational Alternative Thoughts</h4>
            </div>
            <div className="rounded-md border border-blue-200/60 dark:border-blue-800/40 divide-y divide-blue-200/60 dark:divide-blue-800/40 bg-blue-50/20 dark:bg-blue-950/10">
              ...
              {data.rationalThoughts.length > 2 && (
                <div className="py-2 px-3">
                  <p className="text-sm text-blue-600 dark:text-blue-400 italic">+{data.rationalThoughts.length - 2} more rational thoughts</p>
                </div>
              )}
            </div>
          </div>
        ...
        {data.schemaModes && data.schemaModes.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-x-4 gap-y-2 items-start">
            <div className="text-blue-900 dark:text-blue-100">
              <h4 className="font-semibold">Active Schema Modes</h4>
            </div>
            <div className="rounded-md border border-blue-200/60 dark:border-blue-800/40 divide-y divide-blue-200/60 dark:divide-blue-800/40 bg-blue-50/20 dark:bg-blue-950/10">
              ...
              {data.schemaModes.length > 3 && (
                <div className="py-2 px-3">
                  <p className="text-sm text-blue-600 dark:text-blue-400 italic">+{data.schemaModes.length - 3} more modes</p>
                </div>
              )}
            </div>
          </div>
        ...
        {((data.newBehaviors && data.newBehaviors.length > 0) || 
          ...
          <div className="space-y-3 pt-2 border-t border-blue-200/60 dark:border-blue-800/30">
            <div className="grid grid-cols-1 md:grid-cols-[220px,1fr] gap-x-4 gap-y-2 items-start">
              <div className="text-blue-900 dark:text-blue-100">
                <h4 className="font-semibold">Action Plan & Next Steps</h4>
              </div>
              <div className="space-y-3">
              {data.newBehaviors && data.newBehaviors.length > 0 && (
                <div>
                  <p className="text-sm font-semibold text-blue-900 dark:text-blue-100 mb-1">New Behaviors to Practice</p>
                  <div className="rounded-md border border-blue-200/60 dark:border-blue-800/40 divide-y divide-blue-200/60 dark:divide-blue-800/40 bg-blue-50/20 dark:bg-blue-950/10">
              ...
              {data.finalEmotions && data.finalEmotions.length > 0 && (
                <div>
                  <p className="text-sm font-semibold text-blue-900 dark:text-blue-100 mb-2">Emotional Progress</p>
                  <div className="flex flex-wrap gap-2">
