...
export const therapeuticInteractive = {
  ...
  iconButtonLarge:
    'h-12 w-12 p-0 rounded-full hover:bg-primary/10 hover:text-primary transition-colors', // 48px

  // Button variants (Fire Your Design Team compliant)
  buttonPrimary:
    'bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded text-base font-semibold transition-colors',
  buttonSecondary:
    'bg-secondary text-secondary-foreground hover:bg-secondary/90 px-4 py-2 rounded text-base font-semibold transition-colors',
  ...
  cardHover:
    'bg-card text-card-foreground border border-border rounded-lg p-4 hover:bg-muted/50 transition-colors',
