...
describe('Contextual Validation Integration', () => {
  ...
  describe('Report Generation Context Filtering', () => {
    ...
    test('should filter out organizational context distortions', () => {
      ...
      const organizationalMessages: ReportMessage[] = [
        {
          role: 'user',
          content: 'I always organize everything for our team events. Everyone participates and we coordinate all the logistics.'
        },
        {
          role: 'assistant', 
          content: 'It sounds like you take on a lot of responsibility for organizing team activities.'
        },
        {
          role: 'user',
          content: 'Yes, I need to make sure everything runs smoothly. Everyone depends on me to handle all the details.'
        }
      ];
    ...
    test('should accept genuine therapeutic distress patterns', () => {
      const therapeuticMessages: ReportMessage[] = [
        {
          role: 'user',
          content: 'I\'m really struggling lately. I always feel like I\'m not good enough and everyone can see how incompetent I am.'
        },
        {
          role: 'assistant',
          content: 'It sounds like you\'re experiencing some difficult thoughts about yourself. Can you tell me more about these feelings?'
        },
        {
          role: 'user', 
          content: 'I\'m terrified that everything I do will end in failure. I feel like my life is falling apart and nothing ever works out.'
        }
      ];
    ...
    test('should handle mixed context appropriately', () => {
      const mixedMessages: ReportMessage[] = [
        {
          role: 'user',
          content: 'I always handle the project coordination at work, but I\'m starting to worry that my colleagues think I\'m too controlling.'
        },
        {
          role: 'assistant',
          content: 'You seem to have some concerns about how others perceive your leadership style.'
        },
        {
          role: 'user',
          content: 'Yes, I\'m scared that everyone secretly resents me for taking charge of everything. Maybe I should step back, but I\'m terrified that everything will fall apart without my oversight.'
        }
      ];
  ...
  describe('Confidence Adjustment Scenarios', () => {
    ...
    test('should dramatically reduce confidence for routine descriptions', () => {
      const routineContent = 'I always take the same route to work. Everyone in the office knows I arrive at 9am sharp. This system never fails me.';
    ...
    test('should boost confidence for therapeutic context with stress indicators', () => {
      const therapeuticContent = 'I\'m devastated that everyone at work thinks I\'m incompetent. I always mess up presentations and I feel like my career is falling apart.';
    ...
    test('should apply moderate adjustment for ambiguous contexts', () => {
      const ambiguousContent = 'I usually organize everything for family gatherings, but sometimes I wonder if everyone gets annoyed with my planning.';
  ...
  describe('Real-world Message Analysis', () => {
    ...
    test('should properly categorize event planning discussion', () => {
      const eventPlanningSession: ReportMessage[] = [
        { role: 'user', content: 'I\'m organizing everything for my daughter\'s graduation party next weekend.' },
        { role: 'assistant', content: 'That sounds like a big undertaking. How are you feeling about the planning process?' },
        { role: 'user', content: 'Well, everyone in the family expects me to coordinate all the details. I always handle these events.' },
        { role: 'assistant', content: 'It sounds like you take on a lot of responsibility for family events.' },
        { role: 'user', content: 'Yes, I need to make sure everything runs smoothly. The catering, decorations, guest list - everyone depends on me.' }
      ];
    ...
    test('should properly categorize anxiety about social judgment', () => {
      const anxietySession: ReportMessage[] = [
        { role: 'user', content: 'I\'m terrified about tomorrow\'s presentation. I always mess these things up.' },
        { role: 'assistant', content: 'You seem really anxious about the presentation. What specifically worries you?' },
        { role: 'user', content: 'Everyone will see how incompetent I am. I feel like everything I\'ve prepared is garbage.' },
        { role: 'assistant', content: 'Those sound like some harsh thoughts about yourself and the situation.' },
        { role: 'user', content: 'I know, but I can\'t shake the feeling that this will be a complete disaster and everyone will think I\'m a fraud.' }
      ];
