...
describe('Contextual Validation System', () => {
  ...
  describe('analyzeTherapeuticContext', () => {
    ...
    describe('False Positive Detection', () => {
      ...
      test('should detect organizational context with "everything"', () => {
        const content = "I need to organize everything for tonight's event. Everyone will be there and we should make sure all the details are covered.";
      ...
      test('should detect routine context with "always"', () => {
        const content = "I always take the 8am train to work. It's my daily routine and everyone knows I'm punctual.";
        const result = analyzeTherapeuticContext(content);
      ...
      test('should detect factual observation context', () => {
        const content = "Everyone at the conference was networking. This approach never works for technical presentations.";
        const result = analyzeTherapeuticContext(content);
      ...
      test('should detect professional planning context', () => {
        const content = "We should coordinate all the project details. Everyone on the team needs to review the requirements.";
        const result = analyzeTherapeuticContext(content);
    ...
    describe('Therapeutic Context Detection', () => {
      ...
      test('should detect therapeutic distress with "everything"', () => {
        const content = "I'm so worried that everything will fall apart. I feel like I'm ruining everything and everyone thinks I'm incompetent.";
        const result = analyzeTherapeuticContext(content);
      ...
      test('should detect emotional distress with "always"', () => {
        const content = "I always mess up relationships. I'm scared that I'll never find someone who truly cares about me.";
        const result = analyzeTherapeuticContext(content);
      ...
      test('should detect high emotional intensity with amplifiers', () => {
        const content = "I'm panicking because everyone will see how incompetent I am. This is devastating and I feel like I'm falling apart.";
        const result = analyzeTherapeuticContext(content);
  ...
  describe('validateTherapeuticContext', () => {
    ...
    test('should reject organizational context for distortion analysis', () => {
      const content = "I always organize everything for team events. Everyone participates and we coordinate all the logistics.";
    ...
    test('should accept therapeutic context for analysis', () => {
      const content = "I'm terrified that everyone will judge me. I always feel like I'm not good enough and everything I do is wrong.";
      const result = validateTherapeuticContext(content);
