...
describe('sessions-api transforms', () => {
  describe('transformFetchSessionsResponse', () => {
    it('extracts data from ApiResponse format', () => {
      const response = {
        success: true,
        data: [
          { id: 's1', title: 'Session 1', createdAt: '2023-01-01', updatedAt: '2023-01-01', messageCount: 5 },
          { id: 's2', title: 'Session 2', createdAt: '2023-01-02', updatedAt: '2023-01-02', messageCount: 3 },
        ],
  ...
  describe('transformCreateSessionResponse', () => {
    it('extracts data from ApiResponse format', () => {
      const response = {
        success: true,
        data: { id: 's1', title: 'New Session', createdAt: '2023-01-01', updatedAt: '2023-01-01', messageCount: 0 },
        meta: { timestamp: '2023-01-01T00:00:00Z' },
      };
    ...
    it('handles direct session object response', () => {
      const response = { id: 's1', title: 'Direct', createdAt: '2023-01-01', updatedAt: '2023-01-01', messageCount: 0 };
    ...
    it('throws error when response has error', () => {
      ...
      expect(() => transformCreateSessionResponse(response as any)).toThrow('Session creation failed');
    });

    it('throws generic error when response format is invalid', () => {
      const response = { invalid: true };

      expect(() => transformCreateSessionResponse(response as any)).toThrow('Failed to create session');
    });
  });
  ...
  describe('transformDeleteSessionResponse', () => {
    ...
    it('throws generic error when response format is invalid', () => {
      ...
      expect(() => transformDeleteSessionResponse(response as any)).toThrow('Failed to delete session');
    });
  });
